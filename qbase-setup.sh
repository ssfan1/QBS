...
# (c) 2018 by Allroad [FasterPool.com] for qbase 
#
...
cp ~/qbaseMasternodeSetup/nodemon.sh /usr/local/bin
...
addnode=192.168.1.27:13981
addnode=192.168.1.28:13981
EOF
...
If you found it helpful, please donate qbase to:
